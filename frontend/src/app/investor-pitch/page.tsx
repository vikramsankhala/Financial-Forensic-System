 ...
 const slides = [
   ...
   },
   {
     ...
     bullets: [
      'Tranche 1: $1M initial close to fund pilot expansion and core hires.',
      'Tranche 2: $2M after pilot-to-paid conversion milestones.',
      'Tranche 3: $2M after enterprise security + scale milestones.',
      'Use of funds: 40% product/ML, 30% GTM, 20% infra/security, 10% ops.',
     ],
